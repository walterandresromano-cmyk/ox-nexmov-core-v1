      ...
      <div className="container panel join-network-panel">
            ...
            {plans.map((plan, idx) => (
              ...
              >
                ...
                <div className="jnp-card-actions">
                  ...
                  <a
                    href={`https://wa.me/${import.meta.env.VITE_CONTACT_WA}?text=${encodeURIComponent(`Hola oX NEXMOV, quiero consultar sobre el plan ${plan.rankLabel}.`)}`}
                    target="_blank"
        ...
        <section className="join-network-final">
          ...
          <div className="join-network-final-actions">
            ...
            <a
              href={`https://wa.me/${import.meta.env.VITE_CONTACT_WA}?text=${encodeURIComponent("Hola oX NEXMOV, quiero consultar sobre los planes de vendedor.")}`}
              target="_blank"
              rel="noopener noreferrer"
              className="jnp-wa-btn"
            >
