...
const planCommercial = {
  ...
  pro: {
    ...
    headline: "Más cupo y herramientas de financiamiento para operar.",
    ...
    features: [
      ...
      "Métricas estándar.",
      "Consultas con prioridad media.",
      "Presencia visual estándar.",
    ],
    decoyNote: null,
  ...
  elite: {
    ...
    features: [
      ...
      "Radar oX.",
      "Métricas avanzadas.",
      "Consultas de compradores activos.",
      "Kit de redes.",
      "Card promocional.",
      "Señales premium.",
