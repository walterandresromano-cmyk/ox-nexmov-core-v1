      ...
      <div className="container panel admin-panel">
        <div className="panel-head-row">
          <div>
            ...
            <h1>Panel admin</h1>
            <p>
              Control central de dealers, leads comerciales, tickets internos,
              planes, cupos y vencimientos.
            </p>
                    ...
                    <tr key={dealer.id}>
                      ...
                      <td>
                        <div className="admin-benefits-list">
                          ...
                          {dealer.benefits?.extraPublicationQuota > 0 && (
                            <span>
                              +{dealer.benefits.extraPublicationQuota} cupo
                            </span>
                          )}
                      ...
                      <td>
                        <div className="admin-action-row">
                          <button>Ver</button>
                          <button onClick={() => setSelectedDealerForSlots(dealer)}>Cupo extra</button>
