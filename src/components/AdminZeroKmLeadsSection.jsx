...
import ZeroKmLeadDetailModal from "./ZeroKmLeadDetailModal.jsx";
...
export default function AdminZeroKmLeadsSection() {
  ...
  return (
    <div className="admin-section-block">
      <div className="buyer-section-head">
        <div>
          <h2>Leads Financiación 0km</h2>
          <p>
            Vista global de consultas generadas desde la pestaña pública
            Financiación 0km.
          </p>
        </div>
            ...
            <tbody>
              {filteredLeads.map((lead) => (
                <tr key={lead.lead_id}>
                  ...
                  <td>
                    <ZeroKmLeadStatusSelect lead={lead} onUpdated={loadLeads} />
                  </td>
